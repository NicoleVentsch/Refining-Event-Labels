...
- Python 3.7.2 as back-end programming language \cite{python}.
- pm4py, Python library as process mining toolkit \cite{pm4py}.
- NetworkX, Pyhton library for graph manipulation \cite{networkx}. 
- Flask 1.0.2 as web application framework 2 Project \cite{flask}. 
- JavaScript as front-end development language (Standard ECMAScript 2018) \cite{js}.
