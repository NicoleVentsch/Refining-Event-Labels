...
We will seperate the application into two main parts: the back-end, which is responsible for the algorithm and API design, and the front-end to provide a user-friendly interface.\\
\medskip
...
\\
\begin{itemize}
	\item Requirements Specification Document with functional und non-functional requirements
