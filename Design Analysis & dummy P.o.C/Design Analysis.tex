...
be injected in the FileUtility class. Afterward the functionality is accessible in the whole application, additional code is not required.
...
\includegraphics[width=297mm,height=210mm]{"Application Interaction SD".png}
\restoregeometry
\end{landscape}
