...
We could do this by refering to each event through their index in the network, or we could priorly use an injective mapping from all events to their labels. 
