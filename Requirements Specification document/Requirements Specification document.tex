...
The final product consists of a web interface where the user can upload event logs, parametrize thresholds and then the Refining Event Labels algorithm is executed. 
