...
The final system consist of a web interface to upload Event logs, parameterize thresholds and to execute the refining event label algorithm. 
...
Because the project focus is the refining event lable implementation, the project was divided into two systems. This allows a better visualisation 
of the individual algorithm steps and system interactions. The following use cases were identified within the analysis.\\
\medskip
